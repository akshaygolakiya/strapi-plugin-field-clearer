...
import React__default, { useRef, useEffect, useContext, useCallback, useDebugValue, useMemo, useState, useLayoutEffect, createContext as createContext$1, createElement, useReducer } from "react";
import { WarningCircle, CaretDown, Trash, Plus, Star, Cross, Eye, Check } from "@strapi/icons";
import { Popover, Box, Typography, Flex, Button, LinkButton, Link as Link$1, Portal, Alert, Field, SubNav, Badge, TextInput, Checkbox } from "@strapi/design-system";
...
var reactHooksModule = function(_c) {
  var _d = {}, _e2 = _d.batch, batch = _e2 === void 0 ? unstable_batchedUpdates$1 : _e2, _f = _d.useDispatch, useDispatch$1 = _f === void 0 ? useDispatch : _f, _g = _d.useSelector, useSelector$1 = _g === void 0 ? useSelector : _g, _h = _d.useStore, useStore$1 = _h === void 0 ? useStore : _h, _j = _d.unstable__sideEffectsInRender, unstable__sideEffectsInRender = _j === void 0 ? false : _j;
  return {
...
function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
  ...
  function Provider(props) {
    ...
    return /* @__PURE__ */ createElement(Context2.Provider, {
      value
    }, children);
  }
...
var a = "undefined" != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", c = "active", u = "data-styled-version", l = "6.3.8", d = "/*!sc*/\n", p = "undefined" != typeof window && "undefined" != typeof document, h = void 0 === React__default.createContext, f = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== process.env && void 0 !== process.env.REACT_APP_SC_DISABLE_SPEEDY && "" !== process.env.REACT_APP_SC_DISABLE_SPEEDY ? "false" !== process.env.REACT_APP_SC_DISABLE_SPEEDY && process.env.REACT_APP_SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== process.env && void 0 !== process.env.SC_DISABLE_SPEEDY && "" !== process.env.SC_DISABLE_SPEEDY ? "false" !== process.env.SC_DISABLE_SPEEDY && process.env.SC_DISABLE_SPEEDY : "production" !== process.env.NODE_ENV), m = {}, y = /invalid hook call/i, v = /* @__PURE__ */ new Set(), g = function(t2, n2) {
  if ("production" !== process.env.NODE_ENV) {
    ...
    try {
      ...
      }, "function" == typeof React__default.useState && React__default.useState(null), a2 && !v.has(s2) && (console.warn(s2), v.add(s2));
    } catch (e2) {
...
} } : React__default.createContext(xe);
ke.Consumer;
h ? {} : React__default.createContext(void 0);
function Ve() {
  return h ? xe : React__default.useContext(ke);
}
var Le = function() {
  function e2(e3, t2) {
    var n2 = this;
...
function tt(e2, s2, i2) {
  ...
  function D2(e3, s3) {
    return function(e4, s4, i3) {
      var a3 = e4.attrs, c3 = e4.componentStyle, u3 = e4.defaultProps, l2 = e4.foldedComponentIds, d3 = e4.styledComponentId, p3 = e4.target, f3 = h ? void 0 : React__default.useContext(Je), m3 = Ve(), y3 = e4.shouldForwardProp || m3.shouldForwardProp;
      "production" !== process.env.NODE_ENV && React__default.useDebugValue && React__default.useDebugValue(d3);
      ...
      var A2 = function(e5, t2) {
        ...
        return "production" !== process.env.NODE_ENV && React__default.useDebugValue && React__default.useDebugValue(r2.className), r2;
      ...
      var O3 = createElement(S2, N3);
      return h && _3 ? React__default.createElement(React__default.Fragment, null, React__default.createElement("style", { precedence: "styled-components", href: "sc-".concat(d3, "-").concat(P3), children: _3 }), O3) : O3;
    }(T2, e3, s3);
  }
  D2.displayName = v2;
  var T2 = React__default.forwardRef(D2);
...
function ut(n2) {
  ...
  var u2 = /* @__PURE__ */ new WeakMap(), l2 = function(e2) {
    var n3 = Ve(), r3 = h ? void 0 : React__default.useContext(Je), s3 = u2.get(n3.styleSheet);
    if (void 0 === s3 && (s3 = n3.styleSheet.allocateGSInstance(a2), u2.set(n3.styleSheet, s3)), "production" !== process.env.NODE_ENV && React__default.Children.count(e2.children) && console.warn("The global style component ".concat(a2, " was given child JSX. createGlobalStyle does not render children.")), "production" !== process.env.NODE_ENV && i2.some(function(e3) {
      ...
      var d2 = React__default.useRef(true);
    ...
    if (h) {
      ...
      if (f2) {
        ...
        return React__default.createElement("style", { key: y2, "data-styled-global": a2, precedence: "styled-components", href: y2, children: f2 });
      }
    }
    return null;
  };
...
const StepCount = ({ tourName, displayedCurrentStep, displayedTourLength }) => {
  ...
  return /* @__PURE__ */ jsx(Typography, {
    variant: "omega",
    fontSize: "12px",
    children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, {
      id: "tours.stepCount",
...
const ActionsContainer = at(Flex)`
  border-top: ${({ theme }) => `1px solid ${theme.colors.neutral150}`};
`;
const ContentContainer = at(Box)`
  p {
...
`;
const PopoverArrow = at(Popover.Arrow)`
...
const GuidedTourOverlay = at(Box)`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
